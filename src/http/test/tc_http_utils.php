...
class TcHttpUtils extends tc_base{
	function test__StripslashesArray(){
		...
		$ar = ["a" => "b", "c" => "d", "e" => '\\"Very nice\\"'];
		$this->assertEquals(["a" => "b", "c" => "d", "e" => '"Very nice"'],_HTTPUtils::_StripslashesArray($ar));
	}
