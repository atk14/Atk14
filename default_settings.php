...
__defaults__(array(
	...
	"ATK14_COLLECT_SENT_EMAILS" => TEST || DEVELOPMENT,
));
...
__defaults__(array(
	...
	"SESSION_STORER_SET_COOKIES_ONLY_ON_SSL_BY_DEFAULT" => REDIRECT_TO_SSL_AUTOMATICALLY,
));
...
__defaults__(array(
	...
	"DBMOLE_USE_PREPARED_STATEMENTS" => false,
));
...
__defaults__(array(
	...
	"FORMS_MARKUP_TUNED_FOR_BOOTSTRAP5" => USING_BOOTSTRAP5,
...
__defaults__(array(
	"CSP_NONCE" => "", // e.g. (string)String4::RandomString(10)
));
